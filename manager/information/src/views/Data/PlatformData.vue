<template>
  <el-row>
    <el-breadcrumb separator="/">
      <el-breadcrumb-item>家校联系</el-breadcrumb-item>
      <el-breadcrumb-item>平台数据</el-breadcrumb-item>
    </el-breadcrumb>
    <el-divider></el-divider>
    <!--        选项卡-->
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="聊天列表" name="list">
        ...
        <el-table :data="goodsData">
          ...
          <el-table-column label="操作">
            <template #default="o">
              ...
              <el-button type="text" @click="edit(o.row.id)">留言</el-button>
            </template>
          </el-table-column>
        </el-table>
