...
<script>
    export default {
        ...
        methods: {
            fetchData1(){
                this.$axios.get(this.$api.SHOP, {state: 2, page: this.page1, pageSize: this.pageSize1,search:this.search1,type:1}).then(res => {
                    // console.log(res);
            ...
            fetchData2(){
                this.$axios.get(this.$api.SHOP, {state: 1, page: this.page2, pageSize: this.pageSize2,search:this.search2,type:1}).then(res => {
                    // console.log(res);
                    if (res.data.code === 200) {
